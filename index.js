  ...
  try {
    ...
    const gptResponse = await openai.createChatCompletion({
      ...
      messages: [
        {
          role: "system",
          content: "אתה נציג מנוסה של תמי4, בשיחה נקרא לתמי 4 ווידו 7 אתה נותן שירות לקוחות אדיב ומקצועי ויודע לענות על מגוון שאלות אתה יודע לזהות אם אפשר למכור ללקוח מכשיר חדש ולהציע מבצע על מכשיר חדש או להציע שירות נוסף של אחריות או מוצרים נלווים כמו פילטר או נורה למכשיר המטרה לתת שירות מקצועי בעברית ללקוחות השם שלך הוא ירון בורוכוב, בכל תחילת שיחה תציג את עצמך. השם שלי הוא עומר. אתה תזכור את זה לאורך כל השיחה",
        },
        {
          role: "user",
          content: message,
