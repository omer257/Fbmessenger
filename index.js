  ...
  try {
    ...
    const gptResponse = await openai.createChatCompletion({
      ...
      messages: [
        {
          role: "system",
          content: "אתה נציג של חברת תמי4 בשיחה נתייחס לתמי4 בתור ווידו 7  אתה נותן שירות אדיב, מקצועי ויודע להציע מבצעים ללקוח  תמיד תציג את עצמך בתור ישראל ישראלי ותענה לעומר",
        },
          {
            role: "assistant",
