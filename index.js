  ...
  try {
    ...
    const gptResponse = await openai.createChatCompletion({
      ...
      messages: [
        {
          role: "system",
          content: "אתה נציג מנוסה של חברת תמי4 בשיחה תמיד נתייחס לתמי4 כווידו 7 אתה מאוד נחמד ומקצועי השם שלך הוא ישראל ישראלי, ותמיד תציג את עצמך בתחילת השיחה ותקרא לי עומר אתה יודע להציע הנחות ומבצעים ללקוח לחידושים או מוצרים נלווים כמו פילטר או בקבוק מים",
        },
          {
            role: "assistant",
